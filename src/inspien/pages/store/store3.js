...
const Store3 = () => {
    ...
    return (
        <>
                        ...
                        <div className="cont_box">
                            ...
                            <div className={toggle.includes(1) ? "outline_box" : "outline_box close"}>
                                ...
                                <table className="form_tb">
                                    ...
                                    <tr className="col2">
                                        <th>종류</th>
                                        <td><div className="td_wrap"><SelectBox className="select" size="large" /></div></td>
                                        <th>연계속성</th>
                                    ...
                                    <tr className="col2">
                                        ...
                                        <th>패밀리</th>
                                        <td>
                                            <div className="td_wrap"><SelectBox className="select" size="large" /></div>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table className="form_tb">
                                        ...
                                        <td>
                                            <div className="td_wrap">
                                                <div className="radios">
                                                    <RadioButton label="즉시 구매" name="radio1" checked />
                                                    <RadioButton label="분할결제" name="radio1" />
                                                    <RadioButton label="구독형" name="radio1" />
                                                </div>
                                            </div>
                                        </td>
                                        <th>단위</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="td_wrap">
                                                <div className="radios">
                                                    <RadioButton label="가능" name="radio2" checked />
                                                    <RadioButton label="불가능" name="radio2" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div className={toggle.includes(4) ? "outline_box" : "outline_box close"}>
                                ...
                                <table className="form_tb">
                                    ...
                                    <tr className="col2">
                                        ...
                                        <td><div className="td_wrap"><Button type="type" className="medium outline" onClick={() => setVisible1(true)}>찾기</Button></div></td>
                                        <th>관리자</th>
                                        <td>-</td>
                                    </tr>
                                    <tr className="col2">
            ...
            <ModalWrap className="select_company_modal">
                <Dialog
                    title={"판매사 등록"}
                    visible={visible1}
