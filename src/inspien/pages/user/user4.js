...
const User4 = () => {
    ...
    const datas = useMemo(() => [{
        ...
        "권한": <Button className="small dark_gray" onClick={() => setVisible(true)}>조회</Button>
    }], [])
            ...
            <div className="inner">
                ...
                <div className="content">
                    <div className="right_btn_wrap">
                        <Button className="large" onClick={() => window.location.href="/user/user7"}>회사정보</Button>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="td_wrap wrap">
                                            <Checkbox label="전체" name="radio" id="radio1" checked={true} />
            ...
            <ModalWrap className="auth_modal">
                ...
                >
                    ...
                    <div className="center_button_wrap">
                        <Button className="large" onClick={() => setVisible(false)}>확인</Button>
                    </div>
                </Dialog>
            </ModalWrap>
        </UserWrap>
