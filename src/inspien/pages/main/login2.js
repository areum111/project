                ...
                <div className="right_area">
                    ...
                    <div>
                        ...
                        <div className="login_wrap">
                            <h2>LOG IN</h2>
                            <div className="id_input"><img src={UserIco} alt="" /><input className="error" type="text" placeholder="아이디를 입력해주세요." /></div>
                            <div className="id_input pw_input"><img src={PwdIco} alt="" /><input className="error" type="password" placeholder="비밀번호를 입력해주세요." /><button type="button"><img src={EyeIco} alt="" /></button></div>
                            ...
                            <p className="dot_msg error">아이디 또는 비밀번호를 다시 확인해 주세요.</p>
                            <div className="button_wrap">
                                <Button className="full">로그인</Button>
