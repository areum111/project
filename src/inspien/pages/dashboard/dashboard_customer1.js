            ...
            tooltip: {
                ...
                external: function(context) {
                    ...
                    if (tooltipModel.body) {
                        ...
                        innerHtml += '<tr><td><span>초과 사용랑</span></td><td>25GB</td></tr>';
                        innerHtml += '<tr><td><span>초과 요금</span></td><td>2,500원</td></tr>';
                        innerHtml += '</tbody>';
        ...
        <DashboardWrap>
            <div className="inner">
                <div className="title_area">
                    ...
                    <div className="content customer_info">
                        <div className="cont_box">
                            <div className="outline_box">
                                <div className="cnt_box">
                                    <p className="title">판매중 상품</p>
                                    <p className="cnt">10,000,000개</p>
                                </div>
                                <div className="cnt_box">
                                    <p className="title">마일리지</p>
                                    <p className="cnt">10,000,000 M</p>
                                </div>
                                <div className="cnt_box">
                                    <p className="title">결제 예정일</p>
                                    <p className="cnt">6월 25일</p>
                                </div>
                            </div>
                        </div>
                    </div>
