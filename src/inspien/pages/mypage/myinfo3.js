            ...
            <ModalWrap className="out_user_modal">
                <Dialog visible={visible2} size="medium" onCancel={() => setVisible2(false)}>
                    ...
                    <div className="gray_box">
                        <p className="dot_msg">이용중인 상품 및 워크스페이스를 사용할 수 없습니다.</p>
                        <p className="dot_msg">보유한 마일리지가 삭제되며 이후 복구되지 않습니다.</p>
                        <p className="dot_msg">탈퇴 후에도 <span className="red_txt">이번 달까지의 사용 요금과 분할 청구의 남은 잔금은 매달 청구</span>됩니다.</p>
                    </div>
