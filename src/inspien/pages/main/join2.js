            ...
            <div className="inner">
                ...
                <div className="content">
                    ...
                    <div className={toggle.includes(2) ? "outline_box agree_box" : "outline_box agree_box close"}>
                        <div className="check_agree">
                            <Checkbox size="large" label="개인정보처리방침 동의" id="chk3" checked />
                            <p>(필수)</p>
                            <button
                                key="2"
                                type="button"
                    ...
                    <div className={toggle.includes(3) ? "outline_box agree_box" : "outline_box agree_box close"}>
                        <div className="check_agree">
                            <Checkbox size="large" label="계정정보처리방침 동의" id="chk4" checked />
                            <p>(필수)</p>
                            <button
                                key="3"
                                type="button"
                ...
                <div className="button_wrap">
                    <Button className="large" onClick={() => window.location.href = '/main/join3'}>다음</Button>
                </div>
            </div>
        </MemberWrap>
    );
